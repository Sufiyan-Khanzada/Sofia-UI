            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <div class="head1txt">Brand:  <span class="txtsubcard">Tory Burch</span></div>
                        ...
                        <div class="p-t-33">
                            ...
                            <div>Share to</div><span class="p-l-7"><i class="fa fa-facebook"></i></span><span class="p-l-7"><i class="fa fa-twitter"></i></span><span class="p-l-7"> <i class="fa fa-google-plus"></i></span>
</div>
                                </div>
                        </div>
                        <!-- date picker start -->
                ...
                <div class="tab01">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item p-b-10">
                            <a class="nav-link active" data-toggle="tab" href="#description" role="tab">Owner Profile</a>
                        </li>
...
<ul class="days">  
  ...
  <li>31</li>
    ...
    <button type="button" class="btn btn-primary" style="width:100%;height:40px;"><a href="sent_rental.php" style="color: white;text-decoration: none;">Check</a></button>
      </div>
    </div> 
